...
[learn]: pag/reference/platform
{/* i18n-enable localize-links */}
[box-platform-101]: pag/reference/platform/box-platform-101
[use-case]: pag/reference/platform/use-cases
[user-types]: pag/reference/platform/user-types
[application-types]: pag/reference/platform/application-types
[authentication]: pag/reference/platform/authentication-methods
[support]: pag/reference/platform/support
[tooling]: pag/reference/platform/tools
[box-app]: /guides/getting-started/first-application
[endpoints]: pag/reference/reference
[cv]: pag/reference/platform/appendix/locating-values
