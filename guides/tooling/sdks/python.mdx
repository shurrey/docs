...
related_resources: []
alias_paths: []
title: "Install Python SDK (Deprecated)"
---
...
<Card title="Learn more about Python SDK on GitHub" href="https://github.com/box/box-python-sdk"></Card>
...
[python-gen]: /guides/tooling/sdks/python-gen
