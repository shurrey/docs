...
<Card title="Learn more about embedding Box" href="/guides/embed/"></Card>
...
<Card title="Learn more about different User Types" href="pag/reference/platform/user-types"></Card>
