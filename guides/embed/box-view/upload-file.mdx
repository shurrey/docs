...
To upload a file using the [Box SDKs](/sdks-and-tools) or directly with
...
<Card title="Authenticate your application" href="/guides/authentication/app-token"></Card>
...
<Card title="Upload files to Box" href="/guides/uploads/direct/file"></Card>
