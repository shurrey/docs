...
Currently, the element only supports [App Users](pag/reference/platform/user-types)
for authentication.
...
- A valid [Service Account](pag/reference/platform/user-types/#service-account) Access Token.
...
<Card title="Learn about selecting an authentication method" href="/guides/authentication/select"></Card>
...
{/* i18n-disable localize-links */}
[service-account]: pag/reference/platform/user-types/#service-account
