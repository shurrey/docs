...
To stay informed about the API modifications, monitor the [Changelog](pag/reference/changelog) and maintain a current email address in the **App Info** section of the Developer Console.
