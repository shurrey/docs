...
the [`GET /files/:id`](/reference/get_files_id) endpoint the API will return
...
[`GET /folders/:id/items`](/reference/get_folders_id_items) endpoint the API
...
For example, when requesting the [`GET /files/:id`](/reference/get_files_id)
