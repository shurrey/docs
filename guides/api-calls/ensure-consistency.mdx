...
| ------------------------------------------------------------- | ------------------------------- |
| [`POST /files/:id/content`](/reference/post_files_id_content) | Upload a new file version       |
| [`PUT /files/:id`](/reference/put_files_id)                   | Update a file's information     |
| [`DELETE /files/:id`](/reference/delete_files_id)             | Delete a file                   |
| [`PUT /folders/:id`](/reference/put_folders_id)               | Update a folder's information   |
| [`DELETE /folders/:id`](/reference/delete_folders_id)         | Delete a folder                 |
| [`PUT /web_links/:id`](/reference/put_web_links_id)           | Update a web link's information |
| [`DELETE /web_links/:id`](/reference/delete_web_links_id)     | Delete a web link               |
...
| --------------------------------------------------- | ------------------------------- |
| [`GET /files/:id`](/reference/get_files_id)         | Get a file's information        |
| [`GET /folders/:id`](/reference/get_folder_id)      | Get a folder's information      |
| [`GET /web_links/:id`](/reference/get_web_links_id) | Get a web link's information    |
| [`GET /shared_items`](/reference/get_shared_items)  | Get a shared item's information |
