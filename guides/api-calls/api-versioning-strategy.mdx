...
<Tip>
To stay informed about the forthcoming API modifications, monitor the [Changelog](pag/reference/changelog) and maintain a current email address in the Developer Console's App Info section.
</Tip>
...
The versioning strategy applies only to [next generation generated SDKs](pag/reference/sdks-and-tools/#next-generation-sdks).
...
* [API reference](pag/reference/reference)