...
<Card title="Start building a Custom Skill" href="/guides/skills"></Card>
...
<Card title="Learn how to approve Custom Skills" href="/guides/authorization/custom-skill-approval"></Card>
