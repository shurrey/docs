...
<Card title="Learn more about authentication methods" href="/guides/authentication/select"></Card>
...
<Card title="Learn how to approve Platform Apps" href="/guides/authorization/platform-app-approval"></Card>
