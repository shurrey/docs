...
<Card title="Learn more about using logical operators" href="/guides/search/query-operators"></Card>
...
<Card title="Learn more about the Box search index" href="/guides/search/indexing"></Card>
...
<Card title="Learn more about the metadata query API" href="/guides/metadata/queries/comparison"></Card>

[mdq]: /guides/metadata/queries
[mdq_api]: /reference/post_metadata_queries_execute_read
[search]: /reference/get_search
[support]: pag/reference/support
