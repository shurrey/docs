...
[usertypes]: pag/reference/platform/user-types
[serviceaccount]: pag/reference/platform/user-types/#service-account
[appusers]: pag/reference/platform/user-types/#app-user
