...
[User Types](pag/reference/platform/user-types) for more details.
...
<Card title="Learn more about using the Box SDKs with JWT" href="/guides/authentication/jwt/with-sdk"></Card>
...
<Card title="Learn more about manually using JWT authentication" href="/guides/authentication/jwt/with-sdk"></Card>
