...
<Card title="Learn how JWT authentication works" href="/guides/authentication/jwt"></Card>
...
<ImageFrame border center width="300">>
  ![Auth selection screen](../images/custom-app-selection.png)</ImageFrame>
...
<Card title="Learn how to authorize a Platform Application" href="/guides/authorization/platform-app-approval"></Card>
