...
<Card title="Learn more about the query syntax" href="/guides/metadata/queries/syntax"></Card>
...
<Card title="Learn more about paginating query results" href="/guides/metadata/queries/pagination"></Card>