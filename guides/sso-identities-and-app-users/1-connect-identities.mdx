...
* Email association is only viable for [managed users](pag/reference/platform/user-types/#managed-users). [App users](pag/reference/platform/user-types/#app-user) are automatically assigned an email address by Box, meaning that you cannot assign the `login` to be the email from the SSO service.
...
* Only the [managed users](pag/reference/platform/user-types/#managed-users) type is being used, not [app users](pag/reference/platform/user-types/#app-user).
